...
<html lang="en">
    ...
    <body>
        ...
        <div class="col-sm-10">
            <br />
            <form method="post" action="<?= base_url('produtos/incluir') ?>" enctype="multipart/form-data">
                ...
                <div class="form-group-sm col-sm-2">
                    ...
                    <input type="number" class="form-control" name="quantidade" min="0" id="quantidade" required>
                </div>
                ...
                <div class="col-sm-3">
                    <button type="reset" class="btn btn-warning" style="width: 100%;">Limpar</button>
                </div>
                <div class="col-sm-3">
